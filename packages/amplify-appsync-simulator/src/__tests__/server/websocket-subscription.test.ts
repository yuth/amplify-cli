...
describe('websocket subscription', () => {
  ...
  it('should initialize websocket server', () => {
    const subs = new AppSyncSimulatorSubscriptionServer(schema, appSyncConfig, server, subscriptionPath);
  ...
  describe('onConnect', () => {
    let subsServer;
    beforeEach(() => {
      subsServer = new AppSyncSimulatorSubscriptionServer(schema, appSyncConfig, server, subscriptionPath);
    });
